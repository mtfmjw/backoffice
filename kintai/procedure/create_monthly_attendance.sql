...
BEGIN
    ...
    SELECT 
        ...
        CASE WHEN not day_off THEN ((d.day_date + wp.end_time + case when wp.start_time > wp.end_time then interval '1 day' else interval '0 day' end) AT TIME ZONE 'Asia/Tokyo') AT TIME ZONE 'UTC' END AS clock_out_time,
